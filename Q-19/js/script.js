...
function optionSelected(answer){
	...
	let userAns = answer.textContent.trim(); //removes whitespaces before and after the string.
...
function showResultBox(){
	...
	question_section.innerHTML = `<br><br><div class="skipped-answer-ques"><p><i class="fas fa-redo" aria-hidden="true"></i><strong>What you skipped</strong></p><br/><p>${skippedQues.join('<br><br>')}</p><br><br></div>`;
	
	question_section.innerHTML += `<div class="right-answer-ques"><p><i class="fas fa-check" aria-hidden="true"></i><strong>What you know</strong></p><br/><p>${correctAnsQues.join('<br><br>')}</p><br><br></div>`;

	question_section.innerHTML += `<div class="wrong-answer-ques"><p><i class="fas fa-times" aria-hidden="true"></i><strong>What you need to know</strong></p><br/><p>${wrongAnsQues.join('<br><br>')}</p><br><br></div>`;
}